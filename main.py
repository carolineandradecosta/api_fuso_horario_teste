...
@app.get('/fusos/{fuso_horario:path}')
def home(fuso_horario: str):
    return {fuso_horario: datetime.now().astimezone(timezone(fuso_horario)).strftime('%Z %H:%M')}

#  http://127.0.0.1:8000/fusos/Brazil/Acre
#  http://127.0.0.1:8000/fusos/Brazil/east

# @app.get('/fusos/{fuso_horario:path}/fusos2/{fuso_horario2:path}')
# def home(fuso_horario: str, fuso_horario2: str):
#        return \
